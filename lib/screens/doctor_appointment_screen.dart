...
class DoctorAppointmentsScreen extends StatelessWidget {
  ...
  DoctorAppointmentsScreen({required this.doctorEmail});
        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: snapshot.data!.docs.map((doc) {
              ...
              final timeController = TextEditingController(text: appointment['assignedTime'] ?? "");
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: const [
                          Icon(Icons.person, color: Colors.cyanAccent, size: 24),
                          SizedBox(width: 8),
                          Text(
                            'Patient Information',
                            style: TextStyle(
                      ...
                      if (appointment['status'] == 'pending') ...[
                          ...
                          children: [
                            Expanded(
                              child: ElevatedButton.icon(
                                ...
                                label: const Text('Confirm', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                                onPressed: () async {
                            ...
                            Expanded(
                              child: ElevatedButton.icon(
                                ...
                                label: const Text('Reject', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                                onPressed: () async {
                                  await FirebaseFirestore.instance.collection('appointments').doc(doc.id).update({
                                    'status': 'rejected',
                        ...
                        Row(
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                appointment['assignedTime'] ?? 'Not assigned',
                                style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w500),
                                overflow: TextOverflow.ellipsis,
                              ),
                            ),
